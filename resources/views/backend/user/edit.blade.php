...
<div class="container mb-5">
    ...
    <div class=" d-flex items-center justify-content-center ">
        <form class="w-50 p-5 my-5" style="border-radius:10px; box-shadow: rgba(100, 100, 111, 0.2) 0px 7px 29px 0px;"
            action="{{ route('userUpdateAdmin',$user->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="mb-3 col-md-12">
                <img class="imagePreview" id="output00" alt="" src="{{ asset("images/".$user->image) }}"
            ...
            <div class="mb-3">
                ...
                <select name="type" id="" class="form-control" required>
                    <option value="admin" @if ($user->type=="admin")
                        selected
                    @endif>Admin</option>
                    <option value="sub_admin" @if ($user->type=="sub_admin")
                        selected
            ...
            <div class="mb-3">
                ...
                <input type="email" class="form-control @error('email') invalid @enderror" id="exampleInputEmail1"
                    aria-describedby="emailHelp"name="email" value="{{ old('email') ?? $user->email }}" required>
                @error('email')
                    <div class="text-red">
                        {{ $message }}
                    </div>
            ...
            <div class="mb-3">
                ...
                <input type="password" class="form-control @error('confirm_password') invalid @enderror"
                    id="exampleInputPassword1" name="confirm_password" value="{{ old('confirm_password') }}" >
            ...
            <div class="d-flex items-center justify-content-center w-100">
                ...
                <button type="submit" class="btn px-4" style="background: #ff6b6b;color:white">Update User</button>
            </div>
