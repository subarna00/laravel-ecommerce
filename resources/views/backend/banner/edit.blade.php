                    ...
                    <form action="{{route('banner.update',$banner->id)}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input type="text" name="title" class="form-control" value="{{ $banner->title ?? old('title') }}"
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input type="text" name="link" class="form-control" value="{{ $banner->link ?? old('link') }}"
                                    placeholder="Link">
                                @error('link')
                                    <div class="text-red">
                                        {{ $message }}
                            ...
                            <div class="mb-3 col-md-12">
                                ...
                                value="{{ $banner->description ?? old('description') }}"  required>{!! $banner->description !!}</textarea>
                                @error('description')
                                    <div class="text-red">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="mb-3 col-md-12">
                                ...
                                <div class="">
                                    <select name="status"
                                        id="inputState" value="{{ $banner->status ?? old('status') }}" class="default-select form-control wide">
