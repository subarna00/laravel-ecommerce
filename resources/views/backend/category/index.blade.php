        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="">
                        <a href="{{ route('categories.create') }}" class="btn btn-sm btn-primary ml-2">Add + </a>
                    </div>
                </div>
            </div>
            <!-- /.card-header -->
                        ...
                        @if (count($categories) > 0)
                            @foreach ($categories as $key => $category)
                                <tr>
                                    ...
                                    <td><img src="{{ asset('images/' . $category->image) }}" width="50" alt="">
                                    </td>
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            Are you sure to delete <span
                                                                class="text-danger">{{ $category->title }}</span> ? <br>
